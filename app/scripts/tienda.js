document.addEventListener('click', (event) => {
  ...
  function addItemToShoppingCart(itemTitle, itemPrice, itemImage, itemId) {
    ...
    const shoppingCartContent =/* `
      <div class="shoppinCartItem" data-id=${itemId}>
        <figure class="card shopping-cart-item">
          <img class="shopping-cart-image" src= "${itemImage}" />
          <figcaption class="shopping-cart-item-title shoppingCartItemTitle">${itemTitle} </figcaption>
          <figcaption class="shopping-cart-price "> <p class="item-price shoppingCartItemPrice">${itemPrice}</p>  </figcaption>
        </figure>
        <button class="botonBorrar buttonDelete">X</button>
        <input class="shopping-cart-quantity-input shoppingCartItemQuantity elInput" type="number" value="1">
      </div>
      `*/
      `
    <div class="row shoppingCartItem" data-id=${itemId}>
          ...
          <div class="col-4">
              <div
                  ...
                  <input class="elInput shopping-cart-quantity-input shoppingCartItemQuantity" type="number"
                      value="1">
